...
| 蓝牙电量读取 | 部分完成 | 已对已连接 BLE 设备尝试读取标准 GATT Battery Service；BTC 电量读取未完成 |
...
| Bluetooth battery reading | Partially done | Connected BLE devices are read via standard GATT Battery Service when available; BTC battery reading is pending |
