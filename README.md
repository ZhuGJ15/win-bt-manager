...
| 主界面 | 部分完成 | 已用模拟数据展示设备列表、连接状态、电量、展示开关、中英文切换和刷新频率设置 |
...
| Main UI | Partially done | Simulated data now drives device list, connection status, battery level, display toggles, Chinese/English switching, and refresh frequency settings |
