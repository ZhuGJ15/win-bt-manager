...
| 主界面 | 部分完成 | 已用模拟数据展示设备列表、连接状态、电量、展示开关，并支持中英文切换 |
...
| Main UI | Partially done | Simulated data now drives device list, connection status, battery level, display toggles, and Chinese/English switching |
